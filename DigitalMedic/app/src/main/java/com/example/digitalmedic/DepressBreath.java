...
public class DepressBreath extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depress_breath);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DepressBreath.this, DepressVideo.class);
                startActivity(intent);
            }
        });
        ...
        btn_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mp = MediaPlayer.create(DepressBreath.this, R.raw.meditation);
                mp.setLooping(true);
                mp.start();
            }
        });
