...
public class PanicBreath extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panic_breath);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PanicBreath.this, Panic.class);
                startActivity(intent);
            }
        });
        ...
        btn_music.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mp = MediaPlayer.create(PanicBreath.this, R.raw.meditation);
                mp.setLooping(true);
                mp.start();
            }
        });
